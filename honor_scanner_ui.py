    ...
    def launch_scanner(self):
        ...
        try:
            ...
            error_msg = (
                ...
                "   - Ensure honor rankings view is open and accessible\n"
            ...
            error_msg = (
                ...
                "   - Check paths for honor scanner are configured\n"
                ...
                "   - Check honor-scanner.log for details\n\n"
                "Error details: {error}"
            ...
            error_msg = (
                ...
                "4. Restarting the scanner application\n\n"
                "Error details: {error}"
            ).format(error=str(error))
            self.update_ui_signal.emit({
        ...
        if "error" in data:
            ...
            if progress in [25, 50, 75, 100]:
                self.tray_icon.showMessage(
                    "Scan Progress",
                    f"Honor scan is {progress}% complete",
                    QSystemTrayIcon.MessageIcon.Information,
                    3000
                )
